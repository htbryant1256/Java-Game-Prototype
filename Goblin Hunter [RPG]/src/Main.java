/*
 * Henry Bryant Inheritance is when data from a larger parent class can be used in smaller child
 * classes. Parent classes can't use new data created in a child class because of this inheritance.
 * This is very useful because code can be written in the parent class and be used by all child
 * classes below it. Making it very easy for the child classes to all access the same thing.
 * 
...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    // constructers with and without parameters
    Main main = new Main();
        ...
        for (int row = 0; row < 3; row++) {
          for (int column = 0; column < 3; column++) {
            ...
            if (multiArray[row][column] > multiLargeInt) {
              ...
              // search two dimensional array and print coordinates
              xCoordinate = column;
              yCoordinate = row;
            }
          }
  ...
  public static double runCombat(double playerHealth, double playerAttack, int level,
    ...
    if (randMob == 1) {
      ...
      enemyHealth = 30 + (level * .9);
      enemyAttack = 10 + (level * .5);
    }
    ...
    do {
      if (randMob == 1) {
        ...
        enemyRoll = (rand.nextInt(25) + 1) + (.4 * level);
    ...
    while (shop = true) {
      ...
      if (input.toUpperCase().equals("YES")) {
        System.out.println(" ____________________________________________________________________\n"
            ...
            + "|                          |        |           |           |        |\n"
            + "|__________________________|________|___________|___________|________|");
        // exception handling for input of int
        int selection = 0;
        try {
